...
module('Unit | Controller | home', function (hooks) {
  ...
  test('select item', async function (assert) {
    ...
    assert.equal(
      ...
      '',
      'description before select is empty'
    );
    ...
    assert.equal(
      ...
      'test3',
      'name after select is test3'
    );
    assert.equal(
      controller.selecteddescription,
      'test3 description',
      'description after select is test3 description'
    );
  });
  ...
  test('update item', async function (assert) {
    ...
    assert.equal(
      data[2].description,
      'test3 description',
      'item name before updated is test3 description'
    );
    ...
    assert.equal(
      data[2].description,
      'test4 description',
      'item name after updated is test4 description'
    );
  });
