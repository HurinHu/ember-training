...
module('Unit | Controller | about', function (hooks) {
  ...
  test('add new user', async function (assert) {
    ...
    user.save = () => {
      data.push({
        email: 'Alice.Adren@gmail.com',
        firstname: 'Alice',
        lastname: 'Adren',
        avatar: 'http://www.img.com/234.jpg',
        id: 3,
      });
    };
  ...
  test('select user', async function (assert) {
    ...
    assert.equal(
      controller.selectedfirstname,
      '',
      'firstname before select is empty'
    );
    assert.equal(
      controller.selectedlastname,
      '',
      'lastname before select is empty'
    );
    ...
    assert.equal(
      controller.selectedfirstname,
      'Tom1',
      'firstname after select is Tom1'
    );
    assert.equal(
      controller.selectedlastname,
      'John1',
      'lastname after select is John1'
    );
    assert.equal(
      controller.selectedemail,
      'Tom1.John1@gmail.com',
      'email after select is Tom1.John1@gmail.com'
    );
  ...
  test('update user', async function (assert) {
    ...
    assert.equal(
      controller.users[1].firstname,
      'Alice',
      'firstname after updated'
    );
  });
